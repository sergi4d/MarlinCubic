...
#define STRING_CONFIG_H_AUTHOR "@brandstaetter, @grbd, @sergi4d" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "Welcome to AKP TMC2208"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "LinearPlus TMC2208+"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //Falta grabar los datos de hacer el PID
  //#define DEFAULT_Kp valor
  //#define DEFAULT_Ki valor
  //#define DEFAULT_Kd valor
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_DIAGONAL_ROD 270.066
  ...
  #define DELTA_HEIGHT 310.00             // (mm) Get this value from G33 auto calibrate
  ...
  #define DELTA_DIAGONAL_ROD_TRIM_TOWER {-0.564, 0.024, 0.540}  //Calibracion Anterior de Anycubic
...
#if ANYCUBIC_PROBE_VERSION   == (1 || 3)                                     // V1 is NO, V2 is NC, V3 is NO
...
#define DEFAULT_MAX_ACCELERATION       { 2000, 2000, 2000, 2500 }
 ...
 */
#define DEFAULT_ACCELERATION          1500  //3000    // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  1500  //3000    // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   1500  //3000    // X, Y, Z acceleration for travel (non printing) moves
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 0     // Y offset: -front +behind [the nozzle]
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -19.0  // Z offset: -below +above  [the nozzle]
    ...
    #define Z_PROBE_OFFSET_FROM_EXTRUDER -0.2 // Z offset para la sonda de espuma
#else
...
#define XY_PROBE_SPEED 1500   // 6000
